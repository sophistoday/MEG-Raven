...
filename = _thisDir + os.sep + u'data/%s_Pre%s_%s_%s' % (expInfo['participant'],expInfo['runID'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='D:\\Documents\\GitHub\\CNL2_Local\\random-dot-not_motion2Grid_pre_lastrun.py',
...
#print(current_path)
path = current_path + '\\' + expInfo['participant'] + 'pre.txt'  # 在当前路径创建名为run的文本文件
...
for thisTrial in trials:
    ...
    problem0.setImage('pre'+str(run_lst[run_num])+'\\figure'+str(idx_final[run_num,currentLoopNumber])+'_0.jpg')
    problem1.setImage('pre'+str(run_lst[run_num])+'\\figure'+str(idx_final[run_num,currentLoopNumber])+'_1.jpg')
    problem2.setImage('pre'+str(run_lst[run_num])+'\\figure'+str(idx_final[run_num,currentLoopNumber])+'_2.jpg')
    ...
    problem6.setImage('pre'+str(run_lst[run_num])+'\\figure'+str(idx_final[run_num,currentLoopNumber])+'_3.jpg')
    problem7.setImage('pre'+str(run_lst[run_num])+'\\figure'+str(idx_final[run_num,currentLoopNumber])+'_4.jpg')
    ...
    answer1.setImage('pre'+str(run_lst[run_num])+'/target'+str(idx_final[run_num,currentLoopNumber])+'_'+str(rand_idx)+'.jpg')
    answer2.setImage('pre'+str(run_lst[run_num])+'/target'+str(idx_final[run_num,currentLoopNumber])+'_'+str(1-rand_idx)+'.jpg')
